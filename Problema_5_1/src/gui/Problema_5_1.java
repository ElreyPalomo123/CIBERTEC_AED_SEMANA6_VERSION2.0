...
public class Problema_5_1 extends JFrame implements ActionListener {
	...
	// cantidad de edades, edad promedio, edad
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		...
		imprimir("Edad de mayores             :" + ae.edadMayor());
		imprimir("Edad de menores             :" + ae.edadMenor());
		imprimir("Cantidad de mayores de edad :" + ae.cantMayoresEdad());
		imprimir("Cantidad de menores de edad :" + ae.cantMenoresEdad());
	...
	protected void actionPerformedBtnGenerar(ActionEvent arg0) {
		ae.generarEdades();
		imprimir();
		imprimir("Las edades a sido actualizado");
	}
